...
synapse_specs = [ #Hub -> pop_E[1]
    SynapseSpec(hub_neuron.interfaces.V, pop_E.interfaces.V[1], pop_E.interfaces.I_syn[1], syn_hub_to_E), #pop_E[1] -> Hub
    SynapseSpec(pop_E.interfaces.V[1], hub_neuron.interfaces.V, hub_neuron.interfaces.I_syn, syn_E_to_hub), #pop_E -> pop_I (Vectorized block)
    syn_EI
]
