...
p = plot(sol, idxs=[neur.Na.conductance.m, neur.Na.conductance.h], layout=(9,1), size=(800,2000), subplot=1)
plot!(p, sol, idxs=[neur.KCa.conductance.m], subplot=2)
plot!(p, sol, idxs=[neur.CaS.conductance.m, neur.CaS.conductance.h], subplot=3)
plot!(p, sol, idxs=[neur.CaT.conductance.m, neur.CaT.conductance.h], subplot=4)
plot!(p, sol, idxs=[neur.K.conductance.m, neur.K.conductance.h], subplot=5)
plot!(p, sol, idxs=[neur.KDR.conductance.m], subplot=6)
plot!(p, sol, idxs=[neur.H.conductance.m], subplot=7)
plot!(p, sol, idxs=[neur.soma.v], subplot=8)
plot!(p, sol, idxs=[neur.soma.Ca], subplot=9)
